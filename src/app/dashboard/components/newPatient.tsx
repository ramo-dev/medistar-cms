  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild className="fixed bottom-10 right-10">
        <Button variant="default" size="icon" className="rounded-full scale-125 p-3"><Pen /></Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[800px]">
        <DialogHeader>
          <DialogTitle>Patient Onboarding</DialogTitle>
          <DialogDescription>
            Enter the new patient's information here. Click save when you're done.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1">
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="emergencyContact" className="text-right">Emergency</Label>
                <Input id="emergencyContact" type="tel" name="emergencyContact" className="col-span-3" required />
              </div>
            </div>
          </div>
          <div className="flex-1">
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="patientType" className="text-right">Patient</Label>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="insurance" name="insurance" className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="allergies" className="text-right">Allergies</Label>
                <Textarea id="allergies" name="allergies" className="col-span-3" />
              </div>
            </div>
            <DialogFooter>
